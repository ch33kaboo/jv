<footer
	class="footer flex-col md:flex-row items-center justify-center md:justify-normal bg-primary text-primary-content p-10 gap-14 md:gap-0"
>
		...
		<div class="grid grid-flow-col gap-4">
			<a
				><svg
					...
					height="24"
					viewBox="0 0 24 24"
					class="fill-current hover:fill-emerald-100 cursor-pointer transition-all"
					><path
			...
			<a href="https://www.instagram.com/jv_sba/" target="_blank">
				<svg
					...
					height="30"
					viewBox="0 0 24 24"
					class="-translate-y-[3px] fill-current hover:fill-emerald-100 cursor-pointer transition-all"
				>
					<path
